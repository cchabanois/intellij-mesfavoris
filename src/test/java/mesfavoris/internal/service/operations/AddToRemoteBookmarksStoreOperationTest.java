...
public class AddToRemoteBookmarksStoreOperationTest extends BasePlatformTestCase {
	...
	public void testAddToRemoteBookmarksStore() throws Exception {
		// Given
		String storeId = remoteBookmarksStore.getDescriptor().id();
		BookmarkId bookmarkFolderId = new BookmarkId("folder1");
		remoteBookmarksStore.connect(new EmptyProgressIndicator());

		// When
		operation.addToRemoteBookmarksStore(storeId, bookmarkFolderId, new EmptyProgressIndicator());
	...
	public void testCannotAddFolderIfUnderRemoteBookmarkFolder() throws Exception {
		...
		String storeId = remoteBookmarksStore.getDescriptor().id();
		remoteBookmarksStore.connect(new EmptyProgressIndicator());
		operation.addToRemoteBookmarksStore(storeId, new BookmarkId("folder1"), new EmptyProgressIndicator());
